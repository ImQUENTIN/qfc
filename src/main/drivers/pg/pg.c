...
const pgRegistry_t __pg_registry_start[] __attribute__ ((section(".pg_registry1"), used, aligned(4)));
const pgRegistry_t __pg_registry_end[] __attribute__ ((section(".pg_registry3"), used, aligned(4)));

const uint8_t __pg_resetdata_start[] __attribute__ ((section(".pg_resetdata1"), used, aligned(2)));
const uint8_t __pg_resetdata_end[] __attribute__ ((section(".pg_resetdata3"), used, aligned(2)));
