...
{
    // rcModeActivationMask: uint32_t bits[n], n=1, or 2.
    // 只要前32位，多余不要
    memcpy((uint8_t *)&slow->flightModeFlags, (uint8_t *)&rcModeActivationMask, sizeof(slow->flightModeFlags)); //was flightModeFlags;
...
#define BLACKBOX_PRINT_HEADER_LINE_CUSTOM(...)   {__VA_ARGS__}; 
